...
const ExpenseHeadModal = ({ expenseData,ExpenseSuphead,SetExpenseSuphead,}) => {
  ...
  ExpenseHeadModal.propTypes = {
    ...
    const handleInputs = (e) => {
     ...
     const ExpenseData = () =>
     {
       api.post('/expensehead/editsubExpenseHead',Expense)
       .then(()=> {
    ...
    <>
     <Modal size="lg" isOpen={ExpenseSuphead}>
            <ModalHeader>New Sub Head
            <Button color="secondary" onClick={()=>{SetExpenseSuphead(false)}}>
                X
              </Button>
            </ModalHeader>
          ...
          <Row>
              ...
              <Col md="6">
                  <FormGroup>
                  <Label>Title</Label>
                  <Input  type="text" onChange={handleInputs} value={Expense && Expense.title} name="title" />
                  </FormGroup>
              </Col>
               ...
               <ModalFooter>
                    ...
                    <div className="pt-3 mt-3 d-flex align-items-center gap-2">
                        <Button  color="primary" onClick={()=>{ ExpenseData()}}>
                        Submit
                        </Button>
                        <Button color="secondary" onClick={()=>{SetExpenseSuphead(false)}}>
                        Cancel
