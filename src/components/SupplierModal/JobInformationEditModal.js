...
import { Row,Col,Form,FormGroup,Label,Input,Button,Modal,CardTitle } from 'reactstrap';
...
<ComponentCard title='Termination Information'>
              ...
              <Row>
                    <div className="pt-3 mt-3 d-flex align-items-center gap-2">
                        ...
                        <Button onClick={()=>{ setJobInformationEditModal(false) }} type="button" className="btn btn-dark">
                        Go to List
                        </Button>
