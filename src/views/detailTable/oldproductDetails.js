...
import { createTender } from '../../store/tender/tenderSlice';
...
const insertTender = () => {
  ...
  dispatch(createTender(tenderForms)).then(()=> {
            ...
            <Form>
              ...
              {/* <FormGroup>
                <Row>
                  <Col md="10">
                    <Label>Contact</Label>
                    <Input type="select" name="contact_id" onChange={handleInputsTenderForms}>
                        <option value="" selected>Please Select</option>
